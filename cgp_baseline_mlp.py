...
#OBTAIN FILES
drug          = sys.argv[1]
cell_n_feat   = sys.argv[2]
drug_n_feat   = sys.argv[3]

OUT_FOLDER = "/home/zamalloa/Documents/FOLDER/CGP_FILES/CGP_BASELINE_RESULTS/" #For Lab
...
train_table = pd.read_csv(IN_FOLDER + "TRAIN_" + drug + "_C_" + cell_n_feat + "_D_" + drug_n_feat, sep="\t")
valid_table = pd.read_csv(IN_FOLDER + "VALID_" + drug + "_C_" + cell_n_feat + "_D_" + drug_n_feat, sep="\t")
test_table  = pd.read_csv(IN_FOLDER + "TEST_"  + drug + "_C_" + cell_n_feat + "_D_" + drug_n_feat, sep="\t")
...
for drop_out in [0.5]:
    ...
    for l in [2]:
        test_mlp(learning_rate=10.0, L1_reg=0, L2_reg=0.0000000, n_epochs=100, initial_momentum=0.5, input_p=0.2,
                     ...
                     drug_name="Baseline_" +  drug + "_C_" + cell_n_feat + "_D_" + drug_n_feat,
