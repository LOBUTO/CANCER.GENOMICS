...
OBJ_FOLDER <- "~/Documents/FOLDER/OBJECTS/TCGA.TRAINING/"


nci60.cgp.drugs <- readRDS(paste0(OBJ_FOLDER, "052316.NCI60.HMDB.TABLE.643711.rds"))
...
nci60.cgp.drugs <- Function.nci60.hmdb.table("DATABASES/CANCER_DATA/NCI.60/NCI60.TC.HMDB.FP4",
