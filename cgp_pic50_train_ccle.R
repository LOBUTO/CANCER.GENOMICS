...
ccle.cor.pIC50 <- readRDS(paste0(CGP_FILES, "ccle_cor_cgp_pIC50.rds"))
ccle.cor.pIC50$Compound <- as.character(ccle.cor.pIC50$Compound)

print("Done loading data")
################################################################################
#EXECUTE

cgp_anal1 <- Function.cgp.all.data.cor(cgp.cor.pIC50, ccle.cor.pIC50, target_drug = target_drug)
...
target_table <- ccle.cor.pIC50[Compound == target_drug,]
...
write.table(target_table, paste0(TRAIN_TABLES, "pre_train_ccle_",target_drug),
