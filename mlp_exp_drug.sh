...
for keep_prob in 0.5 #0.3 0.5 0.9
do
	for e in 2
	do
		for g in 10
		do
			...
			do
				...
				do
					for drug in Erlotinib I-BET-762
					do
						for slr in 0.1 0.01 0.001 0.0001 0.00001
						do
							for eps in 1 0.1 0.001 0.0001 0.00001 0.000001
							do
								script_name="/tigress/zamalloa/GIT/${script}"
								file_name="${e} ${g} ${d} ${keep_prob} ${arch} ${drug} ${slr} ${eps}"
...
# Erlotinib ZSTK474 CUDC-101 Belinostat Sunitinib CAY10603 \
