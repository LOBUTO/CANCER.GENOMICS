...
multiplot <- function(..., plotlist=NULL, file, cols=1, layout=NULL) {
 ...
 if (numPlots==1) {
    print(plotlist[[1]][["TEMP.PLOT"]] +
          geom_text(aes(plotlist[[1]][["POS"]], 0.85, label= plotlist[[1]][["PVAL"]]), size=8.0))
    ...
    for (i in 1:numPlots) {
      ...
      print(plotlist[[i]][["TEMP.PLOT"]] +
            geom_text(aes(plotlist[[i]][["POS"]], 0.85, label= plotlist[[i]][["PVAL"]]), size=8.0),
