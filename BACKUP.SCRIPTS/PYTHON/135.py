#BACKGROND MODEL PROJECT 4
#Get number of mutations per patient in TOP and NON-TOP from 134.py pickle
#012614

import pickle

#Load dict - patient:distance
PICKLE_IN1=open("DATABASES/CANCER_DATA/TCGA/ALL_PATIENT_DIST_DICT.pi")
...
#Write out to table for R analysis
FILE_OUT1=open("DATABASES/CANCER_DATA/TCGA/FOR_R_ANALYSIS/012614_BRCA_PATIENT_DIST_MUTATIONS","w")
