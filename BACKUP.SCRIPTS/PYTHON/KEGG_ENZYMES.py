#######KEGG_ENZYMES######
#061014
#Produces table of Enzymes and KEGG_ID of products they make
#Straight from KEGG website 
#Based on 146.py
...
print "total starting enzymes:", len(DICT_GENE) #30687 human enzymes, including those with uncharacterized names
