...
#123014
#Assigns trimer info as well as phastcons score (Be wary of trimer infor since it doesn't take
    #into account strand sense)
...
#In 011015 produced 011015.BRCA.MAF.TRIMERS.45.csv with breast cancer data from TCGA (using PHAST.45) - And wrecked the phastcons file accidentally