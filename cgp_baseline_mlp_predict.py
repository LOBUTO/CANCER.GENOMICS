...
####################################################################################################################################################################################################
# Load data
model_folder   = "/tigress/zamalloa/CGP_FILES/CGP_BASELINE_RESULTS/"

target_folder  = "/tigress/zamalloa/CGP_FILES/TRAIN_TABLES/"

out_folder     = "/tigress/zamalloa/CGP_FILES/CGP_BASELINE_FIGURES/"
...
for c in ["10", "20", "50", "100", "200"]:
    for d in ["10", "20", "50", "100", "200"]:
        ...
        for drug in ["Dasatinib", "Camptothecin", "Mitomycin_C", "Imatinib", "Cisplatin", "Sunitinib",
                     ...
                     target_file = "TEST_" + drug + "_C_" + c + "_D_" + d
                     model_file  = 
