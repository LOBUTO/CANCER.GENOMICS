...
MAF.MODEL<-h2o.deeplearning(x=c(1:6), y=7, data=h2o_maf[TRAIN_ROWS[1:100000],],
                            activation = "Tanh", balance_classes = TRUE, hidden = c(1000,500,50), epochs = 400)
print ("done with dnn")
#Save model
h2o.saveModel(MAF.MODEL, "RESULTS", "MAF.MODEL.100000.3.1000.500.50.E.400.REP.CLASS.h2o")
print ("done saving")
