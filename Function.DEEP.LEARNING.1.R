...
MAF.MODEL<-h2o.deeplearning(x=c(1:4,6,7,9,11), y=8, data=h2o_maf[TRAIN_ROWS[1:10000],],
                            activation = "Tanh", balance_classes = TRUE, hidden = c(100,100), epochs = 300)
print ("done with dnn")
#Save model
h2o.saveModel(MAF.MODEL, "RESULTS", "MAF.MODEL.FILTERED.NT.REP.TIME.10000.2.100.100.E.300.h2o")
print ("done saving")
