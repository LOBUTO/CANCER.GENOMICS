...
with open(IN_FOLDER + "/cgp_train_matrix_" + drug +  pcas + ".pkl", "rb") as tr:
    train_table = cPickle.load(tr)
    train_table = pd.DataFrame(train_table)
with open(IN_FOLDER + "/cgp_valid_matrix_" + drug + pcas + ".pkl", "rb") as vd:
    valid_table = cPickle.load(vd)
    valid_table = pd.DataFrame(valid_table)
with open(IN_FOLDER + "/cgp_test_matrix_" + drug + pcas + ".pkl", "rb") as ts:
